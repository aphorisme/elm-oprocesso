...
Elm.JsonEcho = Elm.JsonEcho || {};
Elm.JsonEcho.make = function (_elm) {
   "use strict";
   _elm.JsonEcho = _elm.JsonEcho || {};
   if (_elm.JsonEcho.values)
   return _elm.JsonEcho.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   var hentries = function (es) {
      return function () {
         switch (es.ctor)
         {case "::":
            return A2($List._op["::"],
              A2($Html.div,
              _L.fromArray([$Html$Attributes.$class("entry")]),
              _L.fromArray([A2($Html.span,
              _L.fromArray([]),
              _L.fromArray([$Html.text(es._0)]))])),
              hentries(es._1));
            case "[]":
            return _L.fromArray([]);}
         _U.badCase($moduleName,
   ...
   _op[">>="] = $Task.andThen;
   var setInput = F2(function (inp,
   m) {
      return _U.replace([["typed"
                         ,inp]],
      m);
   });
      ...
      return function () {
         ...
         function (_v5) {
            return function () {
               switch (_v5.ctor)
               {case "_Tuple2":
                  return $Task.succeed(addEntry(A2($Basics._op["++"],
                    "Echoed: ",
                    A2($Basics._op["++"],
                    _v5._0,
                    A2($Basics._op["++"],
   ...
   "Succeed: Bounce back!")),
   function (err) {
      return $Oprocesso.pureParam(addEntry)(A2($Basics._op["++"],
      "Error happened: ",
      err));
   }),
   A2($Oprocesso.pureParam,
   addEntry,
   "Back after Error Handling.")),
   $Oprocesso.pure(addTyped)),
   $Oprocesso.pure(setInput(""))),
   $Oprocesso.pure(addEntry("Async Back.")));
   ...
   var view = function (m) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.id("wrapper")]),
   ...
   var initmodel = {_: {}
                   ,entries: _L.fromArray(["Type: \'v1/the/v2/heck\' to get \'the/heck\' echoed."])
                   ,typed: ""};
...
Elm.Oprocesso.make = function (_elm) {
   "use strict";
   _elm.Oprocesso = _elm.Oprocesso || {};
   if (_elm.Oprocesso.values)
      ...
      return function () {
         ...
         {case "Launch":
            return $Oprocesso$Types.Launch(function (m) {
                 ...
                 function (mo) {
                    return A2($Task.andThen,
                    invoke($Oprocesso$Types.Modify(mo)),
                    function (_v14) {
                       return function () {
                          return A2($Task.andThen,
                          invoke(act2),
            ...
            case "Modify":
            return $Oprocesso$Types.Launch(function (_v18) {
                 return function () {
                    return A2($Task.andThen,
                    invoke(act1),
                    function (_v20) {
...
Elm.Oprocesso.Types.make = function (_elm) {
   "use strict";
   _elm.Oprocesso = _elm.Oprocesso || {};
   _elm.Oprocesso.Types = _elm.Oprocesso.Types || {};
   if (_elm.Oprocesso.Types.values)
